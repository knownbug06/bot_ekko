...
def verify_expressions():
    ...
    # Test Refactored States + New States
    # UWU, RAINBOW_EYES, ANGRY, SCARED were refactored.
    states_to_test = [
        "UWU", "RAINBOW_EYES", "ANGRY", "SCARED", 
        "SAD", "CONFUSED", "CRYING", "EXCITED", "AMUSED", "SURPRISED"
    ]
